...
namespace TVDCEG
{
    public partial class FrmCopyReforcement : Form
    {
        private CopyReforcement _data;
        ...
        public FrmCopyReforcement(CopyReforcement data, a.Document doc)
        {
            _data = data;
            _doc = doc;
            InitializeComponent();
        ...
        private void FrmCopyReforcement_Load(object sender, EventArgs e)
        {
